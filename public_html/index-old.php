                    ...
                    <li >
                       <img src="images/01.jpg" alt="">
                        <p class="flex-caption">
                            <span class="main">DIPNA ANAND
                            <br>
                           Winner of Multiple Awards</span>
                        </p>
                    </li>
                    <li >
                        <img src="images/02.jpg" alt="">
                        <p class="flex-caption">
                        <span class="main"> teach Indian Food as a Chef Lecturer</span>
      ...
      <div class="col-lg-8 col-md-8 col-lg-push-4 col-md-push-4" >
        <div class="content">
          ...
          <?php
					...
					?>
<br/>
            <a href="content.php?code=about" class="pull-right">read more</a></p>
...
?>
<a href="content.php?code=food-as-medicine" class="pull-right clearfix">view all</a>
              </div>
...
<?php
		...
		<?php
			...
			<?php
				foreach($news as $new) {
				?>
				<li><a href="content.php?code=<?php echo $new->Code; ?>"><?php echo $new->Document; ?></a>&nbsp;<?php echo date('d M Y',$new->Published_timestamp); ?>
				</li>
				<?php
				}
				?>
			...
			?>
			 <a href="content.php?code=news" class="pull-right clearfix">view all</a>
              </div>
		<?php
		}		
		?>
