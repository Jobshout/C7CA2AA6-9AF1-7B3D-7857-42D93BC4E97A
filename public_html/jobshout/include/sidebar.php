				...
				<div class="accordion-body collapse" id="collapseDashboard">
					<div class="accordion-inner">
						<ul class="nav nav-list">
							...
							<li <?php if($curr_file=="failedsearches.php") { ?> class="active" <?php }?>><a href="failedsearches.php">Failed Searches</a></li>
				...
				<div class="accordion-body collapse" id="collapseWebContent">
					<div class="accordion-inner">
						<ul class="nav nav-list">
							...
							<li <?php if($curr_file=="manufacturers.php" || $curr_file=="manufacturer.php") { ?> class="active" <?php }?>><a href="manufacturers.php">Manufacturers</a></li>
							<li <?php if($curr_file=="products.php" || $curr_file=="product.php") { ?> class="active" <?php }?>><a href="products.php">Products</a></li>
							<li <?php if($curr_file=="options.php" || $curr_file=="option.php") { ?> class="active" <?php }?>><a href="options.php">Options</a></li>
