...
{ 
	...
	$cntry_name= $db->get_var("select countries_name from countries where countries_id='$Country'");
 ...
 if(isset($_GET['GUID'])){
	          ...
	          $user3 = $db->get_row("SELECT  *  FROM customers where GUID = '".$_GET['GUID']."'");
...
<span class="help-block"></span>
	...
	<?php $countries= $db->get_results("select * from countries");
	foreach($countries as $cntry){	
	  ?>
	<option <?php if($cntry_id==$cntry->countries_id){ ?> selected="selected" <?php } ?> value="<?php echo $cntry->countries_id; ?>"><?php echo $cntry->countries_name; ?></option>
	<?php } ?>
	</select>
