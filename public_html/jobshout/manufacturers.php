...
require_once('include/main-header.php'); ?>
	...
	<ul>
		...
		<?php
					...
					?>
		<li>
			<a href="manufacturer.php">Add new Manufacturer</a>
		</li>
		<?php }?>
					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['manufacturers']) && isset($_SESSION['last_search']['manufacturers']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['manufacturers']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['manufacturers']) && isset($_SESSION['last_search']['manufacturers']['iDisplayLength'])) { echo $_SESSION['last_search']['manufacturers']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['manufacturers']) && isset($_SESSION['last_search']['manufacturers']['iDisplayStart'])) { echo $_SESSION['last_search']['manufacturers']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_manfs.php",
