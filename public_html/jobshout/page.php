...
var body_content='<?php echo addslashes(str_replace('script','scr1pt',preg_replace('/\s\s+/', ' ',$Body)));?>';
body_content = body_content.replace(/scr1pt/g, 'script');
...
tiny_options['moxiemanager_rootpath']= "/";
tiny_options['moxiemanager_path']= "/";

tiny_options['setup'] = function(editor) {  editor.on('blur', function (e) {  generate_metatags();  }); };
tiny_options['init_instance_callback'] = function(inst) { tinyMCE.activeEditor.setContent(body_content);  };
tinymce.init(tiny_options);
