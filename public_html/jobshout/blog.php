...
<li>Enter <b>main-content</b> for Content page Image</li>
								...
								<div class="span3">
									<div class="well form-inline">
										<ul>
											<li>Enter <strong>large-image</strong> for Banner Image</li>
											<li>Enter <strong>thumb-image</strong> for Thumbnail Image</li>
										</ul>
									</div>
			...
			$(document).ready(function() {
				...
				$("#chk_manual").click(function(){
					...
					$(".pic_file").change(function(){
						...
						console.log(parCode_div);
						var imageCodeStr=parCode_div.find('input.pictureCodeClass');
            			...
            			reader.onload = function (e) {
							...
							image.onload = function () {
                        		...
                        		if (imageCodeStr=="large-image" && (height < 850 && width < 275)) {
                            		alert("Height and Width must not exceed 850*275.");
                            		return false;
                        		}else if (imageCodeStr=="thumb-image" && (height < 180 && width > 135)) {
                            		alert("Height and Width must not exceed 180*135");
                            		return false;
                        		}else{
                        			return true;
                        		}
