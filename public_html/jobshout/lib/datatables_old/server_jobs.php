...
require_once("lib.inc.php");
	 ...
	 */
	$aColumns = array('documents.ID','sites.Name', 'documents.Reference', 'documents.Document','documents.PageTitle', "CONCAT( wi_users.firstname, ' ', wi_users.lastname ) as UserName",'documents.Modified','documents.PostedTimestamp','documents.Status','documents.GUID', 'sites.WebsiteAddress', 'documents.Code','documents.Body');
	
	$aColumns1 = array('WebsiteAddress', 'Code', 'ID', 'Name', 'Reference', 'Document', 'PageTitle','UserName', 'Modified', 'PostedTimestamp', 'Status', 'GUID');
